...
public class CompleteResponseProviderImpl implements ICompleteResponseProvider {
    ...
    @Override
    public CompleteResponseDTO getCompleteResponse(String mobileNumber) {
        CustomerDto customerDto = iAccountsService.fetchAccount(mobileNumber);
        ResponseEntity<CardsDto> cardsDtoResponseEntity = iCardsClient.fetchCardDetails(mobileNumber);
        ResponseEntity<LoansDto> loansDtoResponseEntity = iLoansClient.fetchLoanDetails(mobileNumber);
